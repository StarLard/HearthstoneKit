...
public enum HearthstoneAPI {
    ...
    public static func searchCards(with session: URLSession = .shared, for locale: PlayerLocale, setSlug: String? = nil,
                                   ...
                                   gameMode: GameMode.Kind = .constructed, page: Int = 1, pageSize: Int? = nil,
...
private extension HearthstoneAPI {
    ...
    static func searchCards(with accessToken: BattleNetAPI.AccessToken, session: URLSession = .shared, for locale: PlayerLocale,
                            ...
                            gameMode: GameMode.Kind, page: Int, pageSize: Int?, sort: CardSearch.SortPriority, order: CardSearch.SortOrder)
        -> AnyPublisher<CardSearch, Error> {
